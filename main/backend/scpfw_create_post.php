    ...
    <div class="scpfw-container">
        ...
        <div id="tab-default" class="tab-content current">
            ...
            <div class="scpfw_child_div">
                <p class="scpfw_shortcode">Use this shortcode <strong>[scpfw_buttons product_id=id]</strong> (Ex. id = 1,2,3,4,5.... product ids) for any product.</p>
                <?php
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="scpfw_swcrt_select">
                                <input type="radio" name="btn_show" value="sidepopup" <?php if($btn_show == "sidepopup"){ echo "checked"; } ?>>Sidebar Popup
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="scpfw_desc">Lower number means higher position in the order.</span>
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="scpfw_desc">add padding like ex. <strong>10px 15px</strong></span>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="scpfw_swcrt_select">
                                <input type="radio" name="shop_btn_show" value="sidepopup" <?php if($shop_btn_show == "sidepopup") { echo "checked"; } ?>>Sidebar Popup
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="scpfw_swcrt_select">
                                <input type="radio" name="shop_btn_pos" value="after_add_cart" <?php if($shop_btn_pos == "after_add_cart") { echo "checked"; } ?>>After Add To Cart
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <div class="scpfw_child_div">
                <table>
                    <tr>
                        ...
                        <?php
                        $alw_gust_usr = get_post_meta( $post->ID, SCPFW_PREFIX.'alw_gust_usr', true);
                        ?>
                        <td>
            ...
            <div class="scpfw_child_div">
                <table>
                    <tr>
                        ...
                        <?php
                        $tbl_head_bg_clr = get_post_meta( $post->ID, SCPFW_PREFIX.'tbl_head_bg_clr', true); 
                        if($tbl_head_bg_clr == '') {
                            $tbl_head_bg_clr = '#e9ebed';
                        }
                        ?>
                        <td>
                            <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($tbl_head_bg_clr); ?>" name="tbl_head_bg_clr" value="<?php echo esc_attr($tbl_head_bg_clr); ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Table Head Font Color</th>
                        <?php
                        $tbl_head_ft_clr = get_post_meta( $post->ID, SCPFW_PREFIX.'tbl_head_ft_clr', true); 
                        if($tbl_head_ft_clr == '') {
                            $tbl_head_ft_clr = '#000000';
                        }
                        ?>
                        <td>
                            <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($tbl_head_ft_clr); ?>" name="tbl_head_ft_clr" value="<?php echo esc_attr($tbl_head_ft_clr); ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Table Even Row Color</th>
                        <?php
                        $tbl_even_row_clr = get_post_meta( $post->ID, SCPFW_PREFIX.'tbl_even_row_clr', true);
                        if($tbl_even_row_clr == '') {
                            $tbl_even_row_clr = '#d6d8db';
                        }
                        ?>
                        <td>
                            <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($tbl_even_row_clr); ?>" name="tbl_even_row_clr" value="<?php echo esc_attr($tbl_even_row_clr); ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Table Odd Raw Color</th>
                        <?php
                        $tbl_odd_row_clr = get_post_meta( $post->ID, SCPFW_PREFIX.'tbl_odd_row_clr', true); 
                        if($tbl_odd_row_clr == '') {
                            $tbl_odd_row_clr = '#e9ebed';
                        }
                        ?>
                        <td>
                            <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($tbl_odd_row_clr); ?>" name="tbl_odd_row_clr" value="<?php echo esc_attr($tbl_odd_row_clr); ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Table Data Row Font Color</th>
                        <?php
                        $tbl_dtrow_font_clr = get_post_meta( $post->ID, SCPFW_PREFIX.'tbl_dtrow_font_clr', true); 
                        if($tbl_dtrow_font_clr == '') {
                            $tbl_dtrow_font_clr = '#000000';
                        }
                        ?>
                        <td>
                            <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($tbl_dtrow_font_clr); ?>" name="tbl_dtrow_font_clr" value="<?php echo esc_attr($tbl_dtrow_font_clr); ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Table Border</th>
                        ...
                        <td>
                            ...
                            <span class="scpfw_desc">add border like ex. <strong>2px solid #ff0000</strong></span>
                        </td>
                    </tr>
                </table>
            </div>
...
function SCPFW_meta_save( $post_id, $post ) {
    ...
    if (isset($_REQUEST['alw_gust_usr'])) {
    ...
    update_post_meta( $post_id, SCPFW_PREFIX.'alw_gust_usr', $alw_gust_usr );
    update_post_meta( $post_id, SCPFW_PREFIX.'alw_mobile', $alw_mobile );
    update_post_meta( $post_id, SCPFW_PREFIX.'tbl_head_bg_clr', $tbl_head_bg_clr);
    update_post_meta( $post_id, SCPFW_PREFIX.'tbl_head_ft_clr', $tbl_head_ft_clr);
    update_post_meta( $post_id, SCPFW_PREFIX.'tbl_even_row_clr',$tbl_even_row_clr);
    update_post_meta( $post_id, SCPFW_PREFIX.'tbl_odd_row_clr', $tbl_odd_row_clr);
    update_post_meta( $post_id, SCPFW_PREFIX.'tbl_dtrow_font_clr', $tbl_dtrow_font_clr);
